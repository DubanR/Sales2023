...
namespace Sales.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Duban", "Ramirez", "dubanr@yopmail.com", "321 758 5963", "Calle Luna Calle Sol", "Foto mia.jpg", UserType.Admin);
            await CheckUserAsync("1010", "Juan", "Zuluaga", "zulu@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "JuanZuluaga.jpeg", UserType.User);
